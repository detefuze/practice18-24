...
public class ArrayQueueADT {
    ...
    private final ArrayQueueModule[] items = new ArrayQueueModule[SIZE];
    ArrayQueueADT() {
        front = -1;
        rear = -1;
    }
    ...
    public void enQueue(int element) {
        ...
        else
        {
            if (front == -1) front = 0;
            rear = (rear + 1) % SIZE;
            items[rear] = new ArrayQueueModule(element);
    ...
    public int element() {return items[front].element();}
